...
| Base de datos | MySQL 8.4 — 10 tablas de dominio + `_migraciones` |
...
### Modelo de datos (10 tablas de dominio)
...
facturas             → FK contactos, FK usuarios (creado_por), numeracion FAC-YYYY-0001
...
### Módulos JavaScript (14 ficheros)
...
| `cpanel-facturas.js` | CRM | CRUD facturas, lineas editables, calculo de totales, filtros y detalle lateral |
...
| `/api/facturas.php` | GET/POST/PUT/DELETE | Sesión + CSRF | CRUD facturas + lineas + totales |
...
│   └── facturas.php        # Facturas vinculadas a contactos
├── correo/
